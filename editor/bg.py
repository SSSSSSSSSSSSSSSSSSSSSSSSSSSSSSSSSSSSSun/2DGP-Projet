...
class Black_BG():
    image = None
    def __init__(self):
        if Black_BG.image == None:
           Black_BG.image = load_image('resource\\black_BG.png')
    def update(self):
        pass
    def draw(self):
        self.image.clip_draw(0,0,4,4,main_state.window_width//2,main_state.window_height//2,main_state.window_width,main_state.window_height)

class Blue_BG():
    image = None
    def __init__(self):
        if Blue_BG.image == None:
           Blue_BG.image = load_image('resource\\blue_BG.png')
    def update(self):
        pass
    def draw(self):
        self.image.clip_draw(0,0,4,4,main_state.window_width//2,main_state.window_height//2,main_state.window_width,main_state.window_height)
